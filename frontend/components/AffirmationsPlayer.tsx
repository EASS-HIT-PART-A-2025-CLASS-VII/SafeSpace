...
export default function AffirmationsPlayer({ mood, intensity, onBack }: AffirmationsPlayerProps) {
  ...
  const generateAffirmations = async () => {
    ...
    try {
      ...
      setError('Unable to generate affirmations. Using fallback messages.');
    ...
    return (
      <div className={`min-h-screen bg-gradient-to-br ${moodColors[mood]} p-4 flex items-center justify-center`}>
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Creating Your AI Affirmations</h2>
          ...
          <>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 mb-6">
              <div className="text-center">
                ...
                <p className="text-sm text-emerald-600 mt-2">🤖 Generated by AI</p>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4">
              <h3 className="font-semibold text-gray-800 mb-3">Your AI Affirmations</h3>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                💡 Repeat these AI-generated affirmations whenever you need support
              </p>
            </div>
          </>
        )}
